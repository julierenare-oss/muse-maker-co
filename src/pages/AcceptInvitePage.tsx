...
const AcceptInvitePage = () => {
  ...
  const inviter = searchParams.get("inviter") || "Your team owner";
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md">
          <div className="bg-card card-glow rounded-xl p-8 shadow-xl text-center space-y-4">
            ...
            <h2 className="text-lg font-semibold text-foreground">Successfully Joined the Team!</h2>
            <p className="text-sm text-muted-foreground">
              You've been added to the team. Your password has been set and you can now sign in.
            </p>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-card card-glow rounded-xl p-8 shadow-xl">
          ...
          <h2 className="text-lg font-semibold text-foreground text-center mb-2">Team Invitation</h2>
          <p className="text-sm text-muted-foreground text-center mb-6">
            <span className="text-foreground font-medium">{inviter}</span> has invited you to join the Nexagen platform. Set your password to accept the invitation.
          </p>
