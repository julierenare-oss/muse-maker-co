...
import {
  Activity, ArrowDownToLine, ArrowUpFromLine, Calendar as CalendarIcon, Filter, Zap,
} from "lucide-react";
import {
...
// 17 requests across 01.03 — 21.04.2026, with a spike around 20.04 21:25 UTC
const RAW: RequestRow[] = [
  { ts: new Date("2026-03-02T10:14:00Z"), model: "MaaS_Cl_Opus", inputTokens: 1800, outputTokens: 920 },
  { ts: new Date("2026-03-07T13:40:00Z"), model: "MaaS-MJ", inputTokens: 1200, outputTokens: 0 },
  { ts: new Date("2026-03-12T09:05:00Z"), model: "MaaS_image_1", inputTokens: 800, outputTokens: 0 },
  { ts: new Date("2026-03-18T16:22:00Z"), model: "MaaS_Cl_Opus", inputTokens: 5400, outputTokens: 2100 },
  { ts: new Date("2026-03-25T11:00:00Z"), model: "MaaS-MJ", inputTokens: 1500, outputTokens: 0 },
  { ts: new Date("2026-04-02T08:30:00Z"), model: "MaaS_image_1", inputTokens: 950, outputTokens: 0 },
  { ts: new Date("2026-04-08T14:18:00Z"), model: "MaaS_Cl_Opus", inputTokens: 3200, outputTokens: 1450 },
  { ts: new Date("2026-04-12T17:45:00Z"), model: "MaaS-MJ", inputTokens: 1100, outputTokens: 0 },
  { ts: new Date("2026-04-15T10:10:00Z"), model: "MaaS_image_1", inputTokens: 1300, outputTokens: 0 },
  // Spike on 2026-04-20 ~21:25 UTC
  { ts: new Date("2026-04-20T21:18:00Z"), model: "MaaS_Cl_Opus", inputTokens: 7200, outputTokens: 3100 },
  { ts: new Date("2026-04-20T21:22:00Z"), model: "MaaS-MJ", inputTokens: 2400, outputTokens: 0 },
  { ts: new Date("2026-04-20T21:25:00Z"), model: "MaaS_Cl_Opus", inputTokens: 8800, outputTokens: 3650 },
  { ts: new Date("2026-04-20T21:27:00Z"), model: "MaaS_image_1", inputTokens: 1850, outputTokens: 0 },
  { ts: new Date("2026-04-20T21:31:00Z"), model: "MaaS-MJ", inputTokens: 1700, outputTokens: 0 },
  { ts: new Date("2026-04-20T21:36:00Z"), model: "MaaS_Cl_Opus", inputTokens: 6900, outputTokens: 2980 },
  { ts: new Date("2026-04-21T09:15:00Z"), model: "MaaS_image_1", inputTokens: 2100, outputTokens: 0 },
  { ts: new Date("2026-04-21T14:02:00Z"), model: "MaaS-MJ", inputTokens: 1500, outputTokens: 0 },
];
// Total = 17, Total Input ≈ 49,700. Adjust to spec: 63,700. Distribute the +14,000 delta to Opus rows.
RAW[9].inputTokens += 4000;  // 7200 -> 11200
RAW[11].inputTokens += 5000; // 8800 -> 13800
RAW[14].inputTokens += 5000; // 6900 -> 11900
...
// ---------------- Component ----------------
const DashboardPage = () => {
  // The mock data lives in March-April 2026. Default the anchor to April 21, 2026.
  ...
  const filtered = useMemo(
    ...
    [range.from, range.to, selectedModels],
  );
  ...
  // Tokens by Model (stacked bar: input + output)
  ...
  // Model usage trend (multi-line: requests per model per bucket)
  ...
  return (
    <div className="p-6 space-y-6">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      outerRadius={95}
                      paddingAngle={2}
                      label={({ model, percent }) => `${model} ${percent}%`}
                      labelLine={false}
                    >
      ...
      <section className="space-y-4">
        ...
        {/* Token usage over time (area, two layers) */}
        <Card className="card-glow">
          <CardHeader className="pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">
